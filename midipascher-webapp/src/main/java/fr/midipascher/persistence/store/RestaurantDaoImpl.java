...
public class RestaurantDaoImpl implements RestaurantDao {
    ...
    /**
     * @see RestaurantDao#findByExample(fr.midipascher.domain.Restaurant)
     */
    ...
    public List<Restaurant> findByExample(final Restaurant exampleInstance) {
        ...
        if (!CollectionUtils.isEmpty(exampleInstance.getSpecialties())) {
            ...
            restaurantCriteria.createAlias("specialties", "sp", JoinType.INNER_JOIN);
            ...
            for (final FoodSpecialty specialty : exampleInstance.getSpecialties()) {
                ...
                if (StringUtils.isNotEmpty(code)) restaurantCriteria.add(Restrictions.eq("sp.code", code).ignoreCase());
