...
And the "index" page should not contain a "/authenticate" link
And the "index" page should contain a "/accounts/laurent.thibaut@gmail.com/edit" link
...
And the "login" page should contain a "Valid email format is required" text
