...
import fr.midipascher.steps.backend.InactivateFoodSpecialtySteps;
...
public class InactivateFoodSpecialtyStory extends AbstractJUnitStories {
    ...
    public InjectableStepsFactory stepsFactory() {
        return new InstanceStepsFactory(configuration(), new InactivateFoodSpecialtySteps(new Exchange()));
    }
