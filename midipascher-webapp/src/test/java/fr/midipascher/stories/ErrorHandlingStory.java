...
import fr.midipascher.stories.steps.ErrorHandlingSteps;


/**
 * @author louis.gueye@gmail.com
 */
public class ErrorHandlingStory extends JUnitStories {
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new ErrorHandlingSteps());
	}

	@Override
	protected List<String> storyPaths() {
		return new StoryFinder().findPaths(CodeLocations.codeLocationFromClass(this.getClass()).getFile(),
				Arrays.asList("**/error_handling.story"), null);
	}
}
