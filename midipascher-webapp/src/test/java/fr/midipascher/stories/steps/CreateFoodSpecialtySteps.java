...
public class CreateFoodSpecialtySteps {
	...
	public void sendValidCreateFoodSpecialtyRequest() {
		...
		String format = this.format == null ? "application/json" : this.format;
		String language = this.language == null ? "en" : this.language;
	...
	public void setFormat(@Named("format") String format) {
		this.format = format;
	}
	...
	public void sendCreateFoodSpecialtyRequestWithWrongCode(@Named("wrong_code") String code) {
		final FoodSpecialty foodSpecialty = TestUtils.validFoodSpecialty();
