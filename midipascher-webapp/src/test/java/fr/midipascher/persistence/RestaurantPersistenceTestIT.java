...
public class RestaurantPersistenceTestIT extends BasePersistenceTestIT {
  ...
  /**
   * Given : one restaurant with postal code and city properties valued<br/> When : one searches by
   * the above criterion<br/> Then : system should return restaurant {id = 1} and restaurant {id =
   * 2}<br/>
   */
  @Test
  ...
  /**
   * Given : one restaurant with halal property valued<br/> When : one searches by the above
   * criterion<br/> Then : system should return restaurant {id = 2}<br/>
   */
  @Test
  ...
  /**
   * Given : one restaurant with kosher property valued<br/> When : one searches by the above
   * criterion<br/> Then : system should return restaurant {id = 2}<br/>
   */
  @Test
  ...
  /**
   * Given : one restaurant with name property valued<br/> When : one searches by the above
   * criterion<br/> Then : system should return restaurant {id = 2}<br/>
   */
  @Test
