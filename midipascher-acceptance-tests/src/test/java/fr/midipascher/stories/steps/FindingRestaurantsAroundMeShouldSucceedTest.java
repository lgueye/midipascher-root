 ...
 */
public class FindingRestaurantsAroundMeShouldSucceedTest {

    private FindingRestaurantsAroundMeShouldSucceed underTest = null;

    @Before
    public void before() {
        underTest = new FindingRestaurantsAroundMeShouldSucceed();
    }
